...
export function ClientSpaceSection() {
  ...
  return (
    <section id="client-space" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        {/* Demo Section */}
        <div className="bg-gradient-to-br from-brand-blue to-blue-600 rounded-2xl p-8 lg:p-12 mb-16 text-white">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <Button variant="secondary" size="lg" className="bg-white text-brand-blue hover:bg-gray-50">
                Voir la démo
