  ...
  return (
    <section className="relative pt-24 pb-20 bg-gradient-to-br from-brand-sahel via-white to-brand-sahel/50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 bg-brand-laterite/10 text-brand-laterite px-4 py-2 rounded-full text-sm font-medium">
                ...
                L’excellence RH en Afrique Centrale
              </div>

              <h1 className="text-4xl lg:text-6xl font-bold text-brand-dark leading-tight">
                Gérez vos{' '}
                <span className="text-brand-ebony">ressources humaines</span>{' '}
                avec une plateforme 100% gabonaise
              </h1>

              <p className="text-xl italic text-brand-ebony leading-relaxed">
                La solution idéale pour digitaliser les processus RH, simplifier la gestion des talents
                et renforcer la performance sociale dans les entreprises du Gabon.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                'Portail RH bilingue (français & langues locales)',
                'Suivi automatisé des performances et objectifs',
                'Intégration fluide avec la CNSS & DGI',
                'Archivage numérique sécurisé des dossiers du personnel'
              ].map((feature, index) => (
       ...
       <Button asChild className="px-9 py-6 text-lg mt-6 ml-16">
...
<div className="absolute -top-6 -left-10 bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-lg">
  <div className="flex items-center gap-3">
    ...
    <div>
      <div className="text-sm font-semibold text-brand-dark">Hébergée localement</div>
      <div className="text-xs text-brand-slate">Données 100% souveraines</div>
    </div>
  </div>
</div>
...
<div className="absolute -top-10 -right-10 bg-white rounded-xl shadow-xl p-6 border border-brand-sahel">
  ...
  <div className="text-brand-slate text-sm">Utilisateurs actifs</div>
</div>
